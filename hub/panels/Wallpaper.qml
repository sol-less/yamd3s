...
Item {
    ...
    focus: true
    implicitWidth: Metrics.panelWidth("wallpaper")
    implicitHeight: Metrics.panelHeight("wallpaper")
    ...
    Process {
        ...
        onExited: {
            // Assign model only ONCE after scanning finishes
    ...
    GridView {
        ...
        delegate: Item {
            ...
            Rectangle {
                anchors.fill: parent
                anchors.margins: Metrics.spacing.compact
                radius: Metrics.radii.medium
                ...
                Image {
                    ...
                    asynchronous: true
                    // Decodes downscaled thumbnails in background threads (drastically saves VRAM/RAM)
