...
Item {
    ...
    implicitWidth: mode === "circular" ? size + (type === "squiggly" ? squiggleAmplitude * 2 : 0) : size
    implicitHeight:  (mode === "circular" ? size : strokeWidth * 3) + (type === "squiggly" ? squiggleAmplitude * 2 : 0)
