...
Item {
    ...
    focus: true
    implicitWidth:  ConfigManager.vanilla["panels.wallpaper.width"]
    implicitHeight: ConfigManager.vanilla["panels.wallpaper.height"]
    ...
    GridView {
        ...
        delegate: Item {
            ...
            Rectangle {
                anchors.fill: parent
                anchors.margins: ConfigManager.vanilla["layout.spacing.compact"]
                radius: ConfigManager.vanilla["layout.radii.medium"]
